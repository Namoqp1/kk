				...
				for i,v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do 
					if v:IsA("Tool") then 
						if v.Name == _G.SelectedStore then 
							...
							until game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("Dialogue") and game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("Dialogue"):FindFirstChild("Frame") and game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("Dialogue"):FindFirstChild("Frame"):FindFirstChild("3")
							break
						end
					end
				end
					...
					if not game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("WaveUI") then
						...
						for i, v in pairs(workspace.DunMob:GetChildren()) do
							if #v:GetChildren() <= 0 then
								...
								game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(18474.619140625, 98.0782470703125, -869.3956298828125)
								game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(18517.107421875, 98.0782470703125, -832.6771850585938)
								game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(18552.46484375, 98.0782470703125, -860.4462890625)
							else
								if v.Humanoid.Health <= 0 then
									...
									repeat task.wait()
										...
										game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(18517.107421875, 98.0782470703125, -832.6771850585938)
										game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(18552.46484375, 98.0782470703125, -860.4462890625)
									until v and v:IsA("Model") and not v:FindFirstChild("HumanoidRootPart") and not v:FindFirstChild("Humanoid")
								else
									if game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("WaveUI").Wave.Text:lower():find("Countdown") then
										repeat task.wait()
											game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(18491.767578125, 98.0782470703125, -907.4343872070312)
											game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(18474.619140625, 98.0782470703125, -869.3956298828125)
											game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(18517.107421875, 98.0782470703125, -832.6771850585938)
											game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(18552.46484375, 98.0782470703125, -860.4462890625)
										until not game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("WaveUI").Wave.Text:lower():find("Countdown")
									else
										v.Humanoid.WalkSpeed = 0
										v.Humanoid.JumpPower = 0
										repeat
