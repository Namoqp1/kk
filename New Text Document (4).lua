					...
					if not game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("WaveUI") then
						...
						for i, v in pairs(workspace.DunMob:GetChildren()) do
							if v and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
							    ...
							    repeat task.wait()
							        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(18491.767578125, 99.723325729370117, -907.4343872070312)
							    until v and v:FindFirstChild("Humanoid")
							end
						end
					end
				end
